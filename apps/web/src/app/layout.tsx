...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      <body className={`min-h-screen antialiased bg-white dark:bg-black font-sans ${inter.variable} ${jetbrainsMono.variable}`} suppressHydrationWarning>
        <Providers>
          ...
          <div className="titlebar h-10 border-b border-zinc-200 dark:border-zinc-800 flex items-center justify-between fixed top-0 left-0 right-0 z-50 bg-white dark:bg-black px-4 md:px-8 select-none" style={{ WebkitAppRegion: 'drag' } as any}>
            ...
            <span className="text-[10px] text-zinc-400 dark:text-zinc-600 uppercase tracking-[0.2em] font-mono font-bold">$402 Client</span>
